...
Rails.application.configure do
  ...
  # relying on NGINX/Apache to do so instead.
  ...
  # Can be used together with config.force_ssl
  # for Strict-Transport-Security and secure cookies.
  ...
  # information to avoid inadvertent exposure
  # of personally identifiable information (PII). If you
